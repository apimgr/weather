...
func (h *TorAdminHandler) Enable(c *gin.Context) {
	...
	httpPort := 8080 // Default, should be retrieved from actual server config
...
func (h *TorAdminHandler) Regenerate(c *gin.Context) {
	httpPort := 8080 // Should be retrieved from actual server config
...
func (h *TorAdminHandler) ExportKeys(c *gin.Context) {
	...
	_ = publicKey // Public key can be derived from private
}
